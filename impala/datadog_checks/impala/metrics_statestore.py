...
STATESTORE_METRIC_MAP = {
    ...
    "impala_statestore_topic_update_durations_total": {
        "name": "statestore.topic_update_durations",
        "type": "counter",
    },
    "impala_statestore_total_topic_size_bytes": "statestore.total_topic_size",
    "impala_statestore_priority_topic_update_durations_total": {
        "name": "statestore.priority_topic_update_durations",
        "type": "counter",
    },
    "impala_statestore_heartbeat_durations_total": {
        "name": "statestore.heartbeat_durations",
        "type": "counter",
    },
    ...
    "impala_thrift_server_StatestoreService_connections_in_use": "statestore.thrift_server.connections.in_use",
    ...
    # subscriber
    "impala_subscriber_heartbeat_client_cache_clients_in_use": "statestore.subscriber.heartbeat.client_cache_clients.in_use",
    "impala_subscriber_heartbeat_client_cache_total_clients": "statestore.subscriber.heartbeat.client_cache.total_clients",
    "impala_subscriber_update_state_client_cache_clients_in_use": "statestore.subscriber.update_state_client_cache_clients.in_use",
    "impala_subscriber_update_state_client_cache_total_clients": "statestore.subscriber.update_state_client_cache.total_clients",
    # thread_manager
