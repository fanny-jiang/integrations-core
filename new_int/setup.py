...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'new_int', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='datadog-new_int',
    version=ABOUT['__version__'],
    description='The New_Int check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='datadog agent new_int check',
    ...
    packages=['datadog_checks.new_int'],
